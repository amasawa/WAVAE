...
class Model(nn.Module):
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec,
        ...
        '''
        print(x_enc.shape)        torch.Size([32, 96, 321])
        print(x_mark_enc.shape)   torch.Size([32, 96, 4])
        print(x_dec.shape)        torch.Size([32, 144, 321])
        print(x_mark_dec.shape)   torch.Size([32, 144, 4])
        '''
        ...
        # print(seasonal_init.shape) torch.Size([32, 96, 321])
        # print(trend_init.shape) torch.Size([32, 96, 321])
