...
class MLP(nn.Module):
    def __init__(self, args):
        ...
        self.enc = nn.Sequential(
            nn.Linear(self.configs.seq_len * self.configs.x_dim, self.configs.h_dim),
            nn.ReLU(),
    ...
    def forward(self,x, y):
        ...
        '''
        # Encoder
        enc = self.enc(x.view(-1,self.configs.seq_len * self.configs.x_dim))
        ...
        # Decoder
        z_emb = self.z_emd(z)
        dec = self.dec(z_emb.view(-1,1,self.configs.seq_len, self.configs.x_dim))
